...
@Slf4j
public final class MarubeniNetwoking  {
    ...
    public static class Get {
        ...
        public MarubeniNetwoking build() {
            ...
            return new MarubeniNetwoking(this.request);
        }
    }
    ...
    public static class Post {
        ...
        public MarubeniNetwoking build() {
            ...
            if (this.bodyJson != null) {
                body = RequestBody.create(MarubeniNetwoking.JSON, this.bodyJson);
            } else {
    ...
    public MarubeniNetwoking(Request request2) {
        this.request = request2;
    }

    public MarubeniNetwoking setCallback(Callback callback2) {
    ...
    public void execute() {
        ...
        if (this.request == null) {
            log.debug("doInBackground", "request is null, please create instance ");
        } else if (this.callback != null) {
            this.client.newCall(this.request).enqueue(this.callback);
        } else {
            log.debug("doInBackground", "callback is null, please setCallBack() before execute");
        }
    }
